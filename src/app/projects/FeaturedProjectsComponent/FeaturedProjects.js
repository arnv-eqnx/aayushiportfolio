    ...
    <div className="pt-8 w-full flex items-start justify-center gap-12">
      ...
      <div className="onHoverFeaturedProject flex flex-col items-center justify-center">
        ...
        <div className="p-4">
          ...
          <p className="mt-4">
            This project aims to provide a valuable tool for early breast cancer
            detection and risk assessment by leveraging logistic regression, a
            well-established statistical method. Ultimately, it contributes to
            improving healthcare outcomes through data-driven insights and
            predictive modeling.
          </p>
        </div>
      </div>
      ...
      <div className="onHoverFeaturedProject flex flex-col items-center justify-center">
        ...
        <div className="p-4">
          ...
          <p className="mt-4">
            By predicting heart disease, this data science project aims to
            assist healthcare professionals in early detection and risk
            assessment, potentially improving patient outcomes, reducing
            healthcare costs, and promoting preventive measures for individuals
